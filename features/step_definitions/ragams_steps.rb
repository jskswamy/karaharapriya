...
Then /^the ragam "([^"]*)" should be with arohana "([^"]*)", avarohana "([^"]*)" and parent ragam "([^"]*)"$/ do |name, arohana, avarohana, parent_ragam_name|
...
Given /^I have a ragam "([^"]*)" with arohana "([^"]*)", avarohana "([^"]*)" and parent ragam "([^"]*)"$/ do |name, arohana, avarohana, parent_ragam_name|
  parent_ragam = Ragam.find_by_translated_field("name", parent_ragam_name)
  Factory(:ragam, :name => name, :arohana => arohana, :avarohana => avarohana, :parent => parent_ragam)
end
